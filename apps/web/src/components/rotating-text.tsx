...
export interface RotatingTextProps
  ...
  animate?: boolean | VariantLabels | TargetAndTransition | undefined;
    ...
    const next = useCallback(() => {
      const nextIndex =
        currentTextIndex === texts.length - 1
          ? // biome-ignore lint/nursery/noNestedTernary: safe
            loop
            ? 0
            : currentTextIndex
          : currentTextIndex + 1;
          ...
          <motion.div
            ...
            className={cn(
              splitBy === 'lines'
                ...
                : 'relative flex flex-wrap justify-center whitespace-pre-wrap'
            )}
            layout={true}
            aria-hidden='true'
          >
